"""
All the implementaton methods defined within this class have all been sourced
from Naoiki Shibuya (2017) [https://github.com/naokishibuya/car-traffic-sign-classification]
"""
...
def build_pipeline(functions, session, network, optimizer=None, batch_size=128):
    """
